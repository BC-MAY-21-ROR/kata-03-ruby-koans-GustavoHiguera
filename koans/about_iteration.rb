...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is a method that takes a block and an initial value and then applies the block to each element of the array, passing the result of the previous iteration as the initial value for the next iteration.
  end
